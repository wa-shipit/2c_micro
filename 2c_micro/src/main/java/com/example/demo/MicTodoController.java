...
public class MicTodoController {
    ...
    public String addTodo( String userId,String month,String day, String todo) {
        jdbcTemplate.update("INSERT INTO todo (user_id, month, day, todo) VALUES (?, ?, ?, ?)", userId, month, day, todo);
    ...
    public String editTodo(String userId,String month,String day,String todo) {
        jdbcTemplate.update("UPDATE todo SET todo=? WHERE user_id=? AND month=? AND day=?;", todo, userId, month, day);
    ...
    public String deleteTodo(String userId,String month,String day) {
        jdbcTemplate.update("DELETE FROM todo WHERE user_id=? AND month=? AND day=?;", userId, month, day);
